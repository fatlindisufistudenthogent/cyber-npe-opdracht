@REM Commando's zelf worden niet weergegeven, enkel output
 ...
 set VM_VDI_PAD_1="%USERPROFILE%\VirtualBox VMs\NPE_OPDRACHT\%VM_NAAM_1%\Ubuntu_24.10_(64bit).vdi"
 set VM_VDI_PAD_2="%USERPROFILE%\VirtualBox VMs\NPE_OPDRACHT\%VM_NAAM_2%\Kali_Linux_2024.3_(64bit).vdi"
 ...
 echo.
 call :wait_long
 echo 1. Versie Ubuntu 24.10 (64bit): "%USERPROFILE%\Downloads\64bit\64bit\Ubuntu_24.10_(64bit).vdi"
 call :wait_short
 echo 2. Versie Kali Linux 2024.3 (64bit): "%USERPROFILE%\Downloads\64bit_(1)\64bit\Kali_Linux_2024.3_(64bit).vdi"
 echo.
